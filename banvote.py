...
class banvote(minqlx.Plugin):
    ...
    def cmd_unbanvote(self, player, msg, channel):
        ...
        if not votebans:
            ...
            # Verificați dacă jucătorul este votebanned înainte de debanare
            if self.is_votebanned(ident):
                db = self.db.pipeline()
                ...
                channel.reply("^7{} is not currently votebanned.".format(name))
    ...
    def cmd_votebanned(self, player, msg, channel):        
        ...
        def votebans():            
            ...
            if players:                
                ...
                player.tell("There are no votebanned players.")
